...
/// ```rust,ignore  
/// #[derive(cherry::Table)]
/// #[cherry(table = "users", id = user_id, insertable, queryable)]
/// struct User {
///     #[cherry(column = "id")]
///     user_id: u32,
///     first_name: String,
///     last_name: String,
///     #[cherry(get_optional(&str))]
///     email: String,
///     #[cherry(default, set)]
...
/// This is a central requirement of cherry, and if your table does not fulfill this requirement, cherry
...
///
/// # Insertable
/// cherry will generate a helper struct for inserting rows into the database when using
/// `#[cherry(insertable)]`.
/// This struct will contain all fields of the struct, except
/// - the ID
/// - fields annotated with `#[cherry(default)]`
///
...
/// supplying a custom name: `#[cherry(insertable = CreateUser)]`.
...
///
/// # Accessors: Getters
/// cherry will generate accessor functions for fields annotated with `#[cherry(get_one)]`,
/// `#[cherry(get_optional)]` and `#[cherry(get_many)]`.
...
/// supplying a custom name: `#[cherry(get_one = by_id)]`.
/// By default, the function will take a reference to the type of the annotated field as an argument,
/// though this can be changed by supplying a custom type: `#[cherry(get_one(&str)]`.
///
/// # Accessors: Setters
/// cherry will generate accessor functions for fields annotated with `#[cherry(set)]`.
...
/// supplying a custom name: `#[cherry(set = set_name)]`.
///
/// # Custom types
...
#[proc_macro_error::proc_macro_error]
#[proc_macro_derive(Patch, attributes(cherry))]
